...
fs.copyFileSync(
  path.join(__dirname, "../native/repair-dates.py"),
  path.join(output, "repair-dates.py"),
);
fs.copyFileSync(
  path.join(__dirname, "../docs/date-repair.md"),
  path.join(output, "docs/date-repair.md"),
);
...
for (const [from, to] of [
  ...
  fs.copyFileSync(path.join(__dirname, "..", from), path.join(output, to));
}
