...
- Current work: v1.3.0 bounded parallel downloads released and verified.
...
- Next action: after current operations finish, refresh OneDrive and paste the
  v1.3 tool, select 1–5 parallel downloads, and check disk before starting. Native Windows Chrome/Edge
